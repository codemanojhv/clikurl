...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#030712] px-4 font-sans relative overflow-hidden selection:bg-indigo-500/30 selection:text-indigo-200">
      ...
      <div className="absolute top-1/4 left-1/3 w-[450px] h-[450px] bg-indigo-600/5 blur-[100px] rounded-full pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/3 w-[450px] h-[450px] bg-purple-600/5 blur-[100px] rounded-full pointer-events-none" />
      ...
      <Card className="w-full max-w-md p-8 bg-slate-900/40 border border-slate-800/80 backdrop-blur-xl rounded-2xl shadow-xl relative z-10">
        <div className="mb-8">
          ...
          <p className="text-sm text-slate-400">Sign in to your clikurl account</p>
        </div>
        ...
        <p className="text-sm text-slate-400 text-center mt-8">
          ...
          <a href="/register" className="font-semibold text-indigo-400 hover:text-indigo-300 underline underline-offset-2">
            Create one
          </a>
        </p>
      </Card>
